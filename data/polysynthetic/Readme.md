...
- **sample**: [the word *atausiulugu*](atausiulugu.tsv): Verb feat. incorporation and polypersonal agreement, produced by Uqailaut analyzer
...
### For modelling: Necessary morphemes and allomorphs

Morphs from parser: [atausiulugu.morphs.tsv](atausiulugu.morphs.tsv)

Data from http://www.inuktitutcomputing.ca/DataBase/info.php
(does not contain inflectional morphemes)
